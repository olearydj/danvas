...
Status: signed release `v0.22.0` is the latest public beta, not a 1.0 stability promise. This is an unofficial project. It is not affiliated with or endorsed by Instructure.
...
```bash
uv tool install \
  "danvas-cli @ git+https://github.com/olearydj/danvas.git@v0.22.0"
```
...
scripts/release-smoke.sh --expected-version 0.22.0
```

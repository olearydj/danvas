...
4. Basic `files upload` (backlog "Canvas File Upload Helper"): upload one file to a named Canvas Files folder, resolving or creating the folder, printing the file ID/URL/metadata needed by local sources. Markdown asset rewriting stays in sprint 3.
